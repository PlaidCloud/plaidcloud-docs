---
title: RAND(n)
description: "Learn how to use the RAND(N) numeric function in PlaidCloud Lakehouse. Returns a random floating-point value v in the range 0 <= v < 1. Includes syntax and..."
---
