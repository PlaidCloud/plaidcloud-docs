...
| Default Application | Text *(optional)* | Pre-selects this application in the Essbase: Query Cube step form. |
...
- [Essbase: Query Cube](/reference/workflow-steps/essbase/essbase-query/) — run a live MDX query against a cube and land the result in a table.
- [Essbase: Read Dimension](/reference/workflow-steps/essbase/essbase-dimension-read/) — load a dimension outline into a PlaidCloud dimension.
