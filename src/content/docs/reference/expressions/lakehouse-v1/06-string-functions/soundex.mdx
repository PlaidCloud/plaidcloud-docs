---
title: SOUNDEX (Lakehouse v1)
description: SOUNDEX — Generates the Soundex code for a string.
---
...
<Aside>What is Soundex? Soundex converts an alphanumeric string to a four-character code that is based on how the string sounds when spoken in English. For more information, see https://en.wikipedia.org/wiki/Soundex</Aside>
