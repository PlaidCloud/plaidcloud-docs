---
title: REGEXP_INSTR (Lakehouse v1)
description: REGEXP_INSTR — returns the starting index of the substring of the string expr that matches the regular expression specified by the pattern pat, 0 if there is.
---
