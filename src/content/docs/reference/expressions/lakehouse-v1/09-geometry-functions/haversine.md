---
title: HAVERSINE (Lakehouse v1)
description: HAVERSINE — calculates the great circle distance in kilometers between two points on the Earth’s surface, using the Haversine formula.
---
