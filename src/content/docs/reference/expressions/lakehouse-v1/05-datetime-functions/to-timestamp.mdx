---
title: TO_TIMESTAMP (Lakehouse v1)
description: TO_TIMESTAMP — tO_TIMESTAMP converts an expression to a date with time (timestamp/datetime).
---
...
<Aside>Please note that a Timestamp value ranges from 1000-01-01 00:00:00.000000 to 9999-12-31 23:59:59.999999. PlaidCloud Lakehouse would return an error if you run the following statement: ```sql SELECT TO_TIMESTAMP(9999999999999999999); ```</Aside>
