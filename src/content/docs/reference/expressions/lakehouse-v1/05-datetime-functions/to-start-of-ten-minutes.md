---
title: TO_START_OF_TEN_MINUTES (Lakehouse v1)
description: TO_START_OF_TEN_MINUTES — rounds down a date with time (timestamp/datetime) to the start of the ten-minute interval.
---
