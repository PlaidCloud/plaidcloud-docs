---
title: QUANTILE_TDIGEST (Lakehouse v1)
description: QUANTILE_TDIGEST — computes an approximate quantile of a numeric data sequence using the t-digest algorithm.
---
...
<Aside type="caution">NULL values are not included in the calculation.</Aside>
