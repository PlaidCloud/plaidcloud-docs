---
title: GROUP_ARRAY_MOVING_SUM (Lakehouse v1)
description: GROUP_ARRAY_MOVING_SUM — the GROUP_ARRAY_MOVING_SUM function calculates the moving sum of input values.
---
