---
title: STDDEV_POP (Lakehouse v1)
description: STDDEV_POP — return the population standard deviation of an expression (square root of VAR_POP).
---
...
<Aside>STD() or STDDEV() can also be used, which are equivalent but not standard SQL.</Aside>
