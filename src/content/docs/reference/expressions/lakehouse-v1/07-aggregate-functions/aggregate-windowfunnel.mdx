---
title: WINDOW_FUNNEL (Lakehouse v1)
description: WINDOW_FUNNEL — search for ordered event chains within a sliding time window and return the longest match length.
---
...
<Aside>The `event_timestamp` type is timestamp, `3600000000` is a hour time window.</Aside>
