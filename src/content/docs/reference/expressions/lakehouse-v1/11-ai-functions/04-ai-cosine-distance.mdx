---
title: COSINE_DISTANCE (Lakehouse v1)
...
<Aside>The cosine_distance function performs vector computations within PlaidCloud Lakehouse and does not rely on the (Azure) OpenAI API.</Aside>
