---
title: TRUNCATE
description: "Learn how to use the TRUNCATE numeric function in PlaidCloud Lakehouse. Returns the number x, truncated to d decimal places. Includes syntax and examples."
---
