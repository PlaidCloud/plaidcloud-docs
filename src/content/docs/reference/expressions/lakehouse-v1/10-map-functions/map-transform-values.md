...
description: "Learn how to use the MAP_TRANSFORM_VALUES map function in PlaidCloud Lakehouse. Applies a transformation to each value in a map using a lambda expression."
---
