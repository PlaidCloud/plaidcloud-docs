---
title: INFER_SCHEMA (Lakehouse v1)
description: INFER_SCHEMA — automatically detects the file metadata schema and retrieves the column definitions.
---
...
<Aside type="caution">`infer_schema` currently only supports parquet file format.</Aside>
