---
title: LIST_STAGE
description: "Learn how to use the LIST_STAGE table function in PlaidCloud Lakehouse. Lists files in a stage. Includes detailed syntax, examples, and usage reference."
---
