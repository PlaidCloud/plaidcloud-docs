...
The same connection is used elsewhere to *read* from Intacct (for example, [Import Sage AP](/reference/workflow-steps/sage-intacct/import-sage-ap/) or [Import Sage Intacct Query](/reference/workflow-steps/sage-intacct/import-intacct-query/)) — one connection serves both directions. See [Sage Intacct REST Connector](/reference/connectors/rest/sage-intacct/).
...
A step configuration that omits this field entirely — for example one authored through the REST API, MCP, or a workflow bundle import — also defaults to Preview rather than a live post.
