...
<Aside type="caution">
This step has not yet been validated against a live Acumatica tenant. Run every batch in **Validate Only** first, review the result table, and reconcile a handful of postings directly in Acumatica before relying on this step to post live documents unattended.
</Aside>
...
| No live tenant validation | Built to Acumatica's documented contract-based REST API; not yet exercised against a live Acumatica account. |
