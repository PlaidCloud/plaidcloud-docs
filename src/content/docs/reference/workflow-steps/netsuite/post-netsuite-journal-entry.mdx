...
<Aside type="caution">
This step has not yet been validated against a live NetSuite account. Run every batch in **Test Only Mode** first, review the result table, and reconcile a handful of postings directly in NetSuite before relying on this step to post live entries unattended.
</Aside>
