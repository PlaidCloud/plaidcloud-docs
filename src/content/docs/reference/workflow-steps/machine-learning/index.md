...
- [ML: Train Model](/reference/workflow-steps/machine-learning/ml-train/) — fit a scikit-learn model (classification or regression) on a source table and write a queryable one-row model table with the fitted model, parameters, feature list, and training metrics.
