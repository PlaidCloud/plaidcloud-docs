...
<Aside type="caution">
This step has not yet been validated against a live S/4HANA Cloud tenant. Run every batch in **Validate Only** first, review the result table, and reconcile a handful of postings directly in S/4HANA before relying on this step to post live entries unattended.
</Aside>
...
|---|---|
| No live tenant validation | Built to S/4HANA Cloud's documented OData and SOAP APIs; not yet exercised against a live S/4HANA Cloud tenant. |
