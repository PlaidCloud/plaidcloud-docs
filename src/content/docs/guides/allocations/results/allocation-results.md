...
- [Analyze allocations with an AI agent](/guides/allocations/results/analyzing-allocations-with-ai/) — ask, over MCP, why a result changed, what drives it, and what a change would do
