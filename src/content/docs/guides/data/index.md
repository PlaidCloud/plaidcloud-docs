...
- [Vector data type](/guides/data/vector-data-type/) — store pre-computed embeddings in a project table, declare the width you expect, and search for the nearest rows
