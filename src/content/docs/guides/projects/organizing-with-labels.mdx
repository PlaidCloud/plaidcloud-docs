...
The box lists the object's current labels as chips and provides a field for adding more, with an **Add** button beside the field.

## Adding a Label

1. Click anywhere in the **Labels** box to place the cursor in the entry field.
2. Type the label text.
3. Click **Add**, or press **Enter** (or type a comma), to add it.
...
<Aside type="note">
On a workflow step you are creating for the first time, labels you type are held until you save the step, then attached to it. Every other **Labels** box saves each label as soon as you add it.
</Aside>
