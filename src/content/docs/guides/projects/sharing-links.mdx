...
Some screens remember a setting in the link — the Members and Member Directory lists each keep whether you were looking at **All**, **Active Only**, or **Inactive Only** — which your browser shows as an encoded suffix after the screen name. Copy and paste the whole URL and it opens the list you were on; opening it when that list is already up brings that window forward rather than stacking a second one.
