...
<svg viewBox="0 0 680 210" role="img" aria-label="Comparing two projects. A QA project and a Production project are matched item by item; the comparison marks each item as changed, added, or the same. You select which changes to merge, and only those are written into Production." style="width:100%;max-width:680px;height:auto;">
  <defs><marker id="cm-arrow" markerWidth="9" markerHeight="9" refX="7" refY="4.5" orient="auto"><path d="M0,0 L8,4.5 L0,9 z" fill="var(--sl-color-gray-3)" /></marker></defs>
  <rect x="16" y="46" width="150" height="132" rx="8" fill="var(--sl-color-gray-6)" stroke="var(--sl-color-gray-5)" />
  <text x="91" y="40" text-anchor="middle" font-size="12" font-weight="700" fill="var(--sl-color-text)">QA (development)</text>
  <text x="30" y="80" font-size="11" fill="var(--sl-color-text)">workflow: Load</text>
  <text x="30" y="110" font-size="11" fill="var(--sl-color-text)">step: Filter</text>
  <text x="30" y="140" font-size="11" fill="var(--sl-color-text)">variable: year</text>
  <path d="M166 112 L206 112" stroke="var(--sl-color-gray-3)" stroke-width="1.6" fill="none" marker-end="url(#cm-arrow)" />
  <rect x="210" y="40" width="212" height="146" rx="10" fill="none" stroke="var(--sl-color-accent)" stroke-width="2" />
  <text x="222" y="34" font-size="12" font-weight="700" fill="var(--sl-color-accent)">Compare</text>
  <text x="228" y="80" font-size="11" fill="var(--sl-color-text)">● changed</text>
  <text x="228" y="110" font-size="11" fill="var(--sl-color-text)">＋ added</text>
  <text x="228" y="140" font-size="11" fill="var(--sl-color-gray-3)">＝ same</text>
  <text x="360" y="80" font-size="10" fill="var(--sl-color-gray-3)">merge?</text>
  <text x="360" y="110" font-size="10" fill="var(--sl-color-gray-3)">merge?</text>
  <text x="360" y="140" font-size="10" fill="var(--sl-color-gray-3)">skip</text>
  <path d="M422 112 L494 112" stroke="var(--sl-color-gray-3)" stroke-width="1.6" fill="none" marker-end="url(#cm-arrow)" />
  <text x="458" y="104" text-anchor="middle" font-size="10" fill="var(--sl-color-gray-3)">merge selected</text>
  <rect x="496" y="46" width="150" height="132" rx="8" fill="var(--sl-color-gray-6)" stroke="var(--sl-color-accent)" stroke-width="1.6" />
  <text x="571" y="40" text-anchor="middle" font-size="12" font-weight="700" fill="var(--sl-color-text)">Production</text>
  <text x="510" y="112" font-size="10" fill="var(--sl-color-gray-3)">nothing written until</text>
  <text x="510" y="128" font-size="10" fill="var(--sl-color-gray-3)">you apply (dry-run first)</text>
</svg>
<figcaption style="font-size:0.85em;color:var(--sl-color-gray-3);margin-top:0.5rem;">Matched item by item (by id for copies, by name for independent projects), each difference is marked changed, added, or same. You pick which to merge — nothing lands in Production until you apply.</figcaption>
</figure>
