...
<Aside type="note">Pane widths and collapsed states are remembered **per browser and shared across workflows** — they are not saved per workflow. The last pane you resized or collapsed is the layout every canvas you open next will use, and canvas windows you already have open keep the layout they have until you close and reopen them.</Aside>
