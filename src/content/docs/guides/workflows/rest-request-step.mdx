...
description: Call any REST API from a workflow — import an endpoint from Postman, OpenAPI, or HAR, send a test request, and route the response to a table or to workflow variables.
sidebar:
  order: 20
---
...
2. Choose **REST Request** as the step type. The editor opens with a **Request** tab and a **Response** tab.
