...
<Aside type="note">**Test Connection** is also available for [TM1](/guides/connections/tm1/), [Oracle Essbase](/guides/connections/essbase/), and [HFM/FCCS](/guides/connections/hfm-fccs/) connections, in addition to the database types above. NetSuite and other REST connections don't have it — smoke-test those by sending a small request from a workflow step (for NetSuite, see [Connect to NetSuite](/guides/connections/netsuite/#smoke-test-the-connection)).</Aside>
