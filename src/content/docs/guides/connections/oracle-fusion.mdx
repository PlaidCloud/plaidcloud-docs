...
<Aside type="caution">
This connector is built to Oracle Fusion's documented OData and BIP endpoints and has not yet been validated against a live Oracle Fusion Cloud environment. Run every import against a test environment first, and work through **Validate Only** below on every post batch before posting live.
</Aside>
...
<Aside type="caution">
- **No live tenant validation.** Built to Oracle Fusion's documented OData, BIP, and FBDI/ESS endpoints; not yet exercised against a live Oracle Fusion Cloud environment. Validate field mappings and posting behavior in a test environment before relying on this step in production.
