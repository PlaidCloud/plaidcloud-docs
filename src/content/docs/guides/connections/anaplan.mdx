...
- Either an Anaplan **username and password**, or a **CA certificate and its private key** registered to an Anaplan user by your Workspace Administrator — with read access to the workspace and models your workflows will read. See [Authentication](#authentication) below.
...
3. Fill in the fields:
   ...
   | Authentication Mode | **Basic** (default) or **Certificate**. See [Authentication](#authentication) above. |
