...
Once your tenant has at least one external lakehouse registered, the **New Project** dialog (**Analyze > Projects > New Project**) offers a lakehouse picker: choose **Tenant Default** to use the built-in PlaidCloud Lakehouse, or pick the registered external lakehouse. From then on:
