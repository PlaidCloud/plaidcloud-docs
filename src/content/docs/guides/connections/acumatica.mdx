...
<Aside type="caution">
This connector is built to Acumatica's documented contract-based REST API and has not yet been validated against a live Acumatica tenant. Run every import against a sandbox company first, and work through **Preview and Validate** below on every post batch before posting live.
</Aside>
