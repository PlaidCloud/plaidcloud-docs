...
- **Your dashboard account has to exist.** It is created for you the first time you open a dashboard from PlaidCloud. Until then the list is empty rather than unrestricted — open any dashboard once and it fills in.
