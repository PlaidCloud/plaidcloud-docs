...
It always proposes before it builds. You get a plain summary of the step it would create — the columns it writes and where each source's columns came from, any row filter, whether it groups and totals, the table it writes into, the folder it files the step under, and whether it joins a workflow — and **nothing is created until you reply**. If the proposal isn't what you meant, say what to change and it proposes again.
