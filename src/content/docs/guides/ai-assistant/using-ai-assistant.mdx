...
- **Build** — write a query, build a workflow
- **Import** — import a file into a table
- **Learn** — look something up in the docs

1. Click the wand button beside the message box
2. Pick a category, then a task
3. Fill in what the task asks for — a table name, a file name, or what you want to know — and click `Start`

The task writes the message for you and puts it in the message box. Read it, change anything you want, then press Enter to send it. Nothing is sent until you send it.
...
<Aside type="note">Where a task asks for a table or a workflow, type its name — the assistant looks it up as part of answering.</Aside>
