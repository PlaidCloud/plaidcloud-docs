...
<YouTube
  id="GcRxWRQ_ja4"
  title="What's New in PlaidCloud — June 2026"
  caption="Two minutes on seven of this month's changes — data connectors, the Multi-Table Join designer, the Forecast and Solver steps, table snapshots, project compare and merge, and Where Used — and what each one saves you."
/>
