...
<YouTube
  ...
  caption="Under two minutes on seven of this month's changes: data connectors, the Multi-Table Join designer, the Forecast and Solver steps, table snapshots, project compare and merge, and Where Used."
/>
