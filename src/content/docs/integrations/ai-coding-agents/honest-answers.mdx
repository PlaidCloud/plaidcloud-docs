...
Where an answer's figures come from a conserved pool it already said the two are separate measurements. That sentence is offered only there — so an answer narrowed to one line of business, entity or programme, which is precisely where the factor named is most often the pool total and the concentrated member sits inside the narrowing, said it nowhere.
