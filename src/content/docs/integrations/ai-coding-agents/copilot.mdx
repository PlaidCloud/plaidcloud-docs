...
You can also reach these steps from PlaidCloud's own **Connect Your AI** window — find GitHub Copilot under the **Other** tab, alongside Gemini CLI and Codex CLI.
