...
<Aside>By default, the member who created the workspace will be assigned to it automatically.</Aside>
...
<Aside>Deletion is a permanent action. This process will delete the workspace and all associated data. Be sure you have everything you need backed up before doing this.</Aside>
