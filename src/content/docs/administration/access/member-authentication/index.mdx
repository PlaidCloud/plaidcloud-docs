...
Signing out ends your PlaidCloud session and returns you to a signed-out page. To return to PlaidCloud, sign in again.

<Aside>You will be asked to sign in again the next time you return to PlaidCloud.</Aside>

Your administrator can optionally configure PlaidCloud to also end your single sign-on session with your identity provider when you sign out.
