...
If you'd rather see a finished result before you build one, take the shortcut. On a brand-new workspace, your board opens with a **Load sample** button. Click it, and PlaidCloud seeds a ready-made **Retail Sales Analysis** project, runs its workflow — importing a retail sales file, cleaning it, and summarizing revenue by region — and opens the result for you. You reach a real first result in a few minutes without building anything, and every piece it created is yours to open, change, and rerun. If loading or running the sample hits a problem, the board tells you and offers to try again.
